...
import 'package:app/signup/signup.dart'; // appInputDecoration, etc.

/// ------------------------------------------------------------------
///  SIGNUP BLUEPRINT STEP  (top‑level function)
/// ------------------------------------------------------------------
Widget studentCoursesStep(
  BuildContext context,
  GlobalKey<FormBuilderState> formKey,
) {
  final signupState = context.read<SignupCubit>().state;
  final existingCourses = signupState.student.courses;
              ...
              return Column(
                children: [
                  ...gradeOrder.map((g) {
                    ...
                    final borderColor = selectedSubjects.isNotEmpty
...
String _subjectLabel(Subject s) => s
    .toString()
    .split('.')
    .last
